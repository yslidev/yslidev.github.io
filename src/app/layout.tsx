...
// 3. FAQPage — the highest-value schema for AEO: AI engines (Perplexity,
//    ChatGPT Search, Google AI Overviews) extract Q&A pairs directly from this
//    to generate answers when someone asks about Yushan Li.
const faqLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: [
